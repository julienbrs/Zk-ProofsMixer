...
import { useColorModeValue, Flex, Menu, MenuButton, Button, MenuList, MenuItem, Text, Box, Input } from "@chakra-ui/react";
    ...
    return (
        <Box bg={useColorModeValue("#f7e2da", "#f4f2fc")} borderRadius={"xl"} mx={6} p={4}>
            <Flex direction="column">
                ...
                <Input placeholder="Enter secret" bg={useColorModeValue("#ffffff", "#957de3")} borderRadius={"lg"} />
            </Flex>
        </Box>
    )
}